...
<?php if( $config->get('cat_show_title') ) { ?>
	...
	<div class="blog-meta">
		...
		<span class="author"><span><?php echo $this->language->get("text_write_by");?></span> <?php echo $blog['author'];?> - <?php echo date("d",strtotime($blog['created']));?>
		<?php echo date("M",strtotime($blog['created']));?> / <?php echo date("Y",strtotime($blog['created']));?></span>
		<?php } ?>
	...
	<div class="blog-body">
		...
		<div class="image"><img src="<?php echo $blog['thumb'];?>" title="<?php echo $blog['title'];?>"/></div>
		<?php } ?>
	...
	<div class="link-more">
		<a href="<?php echo $blog['link'];?>" class="button"><?php echo $this->language->get('text_readmore');?></a>
		<?php } ?>
	</div>
</div>