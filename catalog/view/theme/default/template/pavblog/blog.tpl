...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="pav-blog">
		...
		<div class="blog-meta">
		 ...
		 <div class="description clearfix"><?php if( $blog['thumb_large'] ) { ?>
			<div class="image">
				<img src="<?php echo $blog['thumb_large'];?>" title="<?php echo $blog['title'];?>"/>
			</div>
			<?php } ?><?php echo $description;?></div>
			...
			<?php if( $config->get('blog_show_comment_form') ) { ?>
				...
				<?php }else { ?>
					...
					<form action="<?php echo $comment_action;?>" method="post" id="comment-form">
						...
						<br/>
						<div class="buttons">
							<input class="btn btn-submit button" type="submit" value="<?php echo $this->language->get('text_submit');?>">
