...
$subtitle = $this->language->get('module_featured_subheader');
          ...
          <div class="view-content">
            ...
            <div class="image">
              ...
              <div class="sale-badge">
                <?=$this->config->get('layout_product_showsalebadge_title');?>
              </div>
              <? } ?>
...
?>
            ...
            <div class="box-product-buttons clearfix"> <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="buttons-cart"><?php echo $button_cart; ?></a> <a onclick="addToWishList('<?php echo $product['product_id']; ?>');" class="buttons-wish" title="<?php echo $button_wishlist; ?>"></a> <a onclick="addToCompare('<?php echo $product['product_id']; ?>');" class="buttons-compare" title="<?php echo $button_compare; ?>"></a> </div>
          </div>
        </div>
      </div>
