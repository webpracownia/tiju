...
class ControllerModulePavblog extends Controller {
	...
	public function index(){
		...
		$this->data['heading_title'] = strip_tags($this->language->get('panel_page_heading_title'));
	...
	public function category(){
		...
		$this->data['heading_title'] = strip_tags($this->language->get('category_page_heading_title'));
	...
	public function blog(){
		...
		$this->document->setTitle( strip_tags($this->language->get('blog_page_heading_title')) );
		$blog = array(
			'blog_id'=>0,
			'featured' => 0,
			'category_id'=>0,
